...
//        fis.close();
    ...
    public void test4(){
        ...
        try {
            //创建文件和相应的流
            br = new BufferedReader(new FileReader(new File("F:\\IDEA Data\\src\\hello.txt")));
            bw = new BufferedWriter(new FileWriter(new File("F:\\IDEA Data\\src\\helloBufferedReader.txt")));
